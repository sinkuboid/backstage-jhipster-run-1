...
To build the final jar and optimize the jhipsterSampleApplicationRun1 application for production, run:
...
Then navigate to [http://localhost:5151](http://localhost:5151) in your browser.
